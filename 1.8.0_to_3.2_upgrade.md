...
1.  **Download WebUI:** Get the latest version: [`webui_v5.0.1.zip`](https://github.com/Chauvet-Pro/WELLCONNECT/raw/refs/heads/main/firmware/webui_v5.0.1.zip).
2.  **Download Box Firmware:** Get the latest 3.2 firmware: [`well_connect_firmware_v3.2_latest.zip`](https://github.com/Chauvet-Pro/WELLCONNECT/raw/refs/heads/main/firmware/well_connect_firmware_v3.2_latest.zip).
