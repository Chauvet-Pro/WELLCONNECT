...
> ## IMPORTANT:  
> Use the box version that matches the phone version. Always use the latest box version.
> 
> Versions are labeled as WELL_CONNECT, but these are actually the firmware for both the WELL CONNECT and Freedom CONNECT boxes.

> ### WEBUI Latest Version:  
> [webui_v4.1.1.zip](firmware/webui_v4.1.1.zip)
